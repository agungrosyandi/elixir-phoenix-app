defmodule RaffleyWeb.CoreComponents do
  ...
  # default component without tailwindCSS  -----------------------------------
  ...
  # flash using Tailwind CSS more styling  -----------------------------------
  ...
  def flash(assigns) do
    ...
    <div
      ...
      phx-click={JS.push("lv:clear-flash", value: %{key: @kind}) |> hide("##{@id}")}
      role="alert"
      class="fixed top-2 right-2 z-50 animate-slide-in"
      {@rest}
    >
      <div class={[
        ...
        @kind == :success && "bg-green-50 border-green-200 text-green-900",
        @kind == :warning && "bg-yellow-50 border-yellow-200 text-yellow-900"
      ]}>
        <.icon
          :if={@kind == :info}
        ...
        <.icon
          ...
          class="size-5 shrink-0 text-yellow-600"
        />
        ...
        <button
          type="button"
          class="group self-start cursor-pointer ml-2"
