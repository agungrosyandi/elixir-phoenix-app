defmodule RaffleyWeb.Router do
  ...
  scope "/", RaffleyWeb do
    ...
    live_session :admin,
      ...
      live "/admin/raffles", AdminRafflesLive.Index
      live "/admin/raffles/new", AdminRafflesLive.Form, :new
      live "/admin/raffles/:id/edit", AdminRafflesLive.Form, :edit
